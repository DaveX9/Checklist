...
//     host: 'localhost',
//     user: 'root',
//     password: '10331846@#Dev',
//     database: 'vehicle_db'
// };

// // Route สำหรับเรียกดูข้อมูลย้อนหลัง 5 วัน
...
//             WHERE DATE(created_at) BETWEEN CURDATE() - INTERVAL 5 DAY AND CURDATE()
...
// // ส่วนของ route อื่นๆ คุณสามารถวางไว้ที่นี่ต่อได้เลย...
// app.use(bodyParser.json());
// app.use(express.static("views"));
...
// // อย่าลืม export ตัวแปร app ด้านล่างนี้ เพื่อใช้ใน server.js
// module.exports = app;
