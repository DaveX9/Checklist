...
app.post("/webhook", (req, res) => {
    ...
    events.forEach(async (event) => {
        if (event.type === "message" && event.message.type === "text") {
            ...
            if (userMessage === "1") {
                const howToText = `📝 วิธีการใช้งานแบบฟอร์มเช็กของบนรถ 1. กดเมนู แบบฟอร์ม2. ระบบจะแสดงแบบฟอร์มเช็กลิสต์3. ใส่ชื่อผู้ตรวจ และเลือกทะเบียนรถที่ต้องการเช็ก (วันและเวลา อัตโนมัติ)4. กดบันทึกข้อมูล และเริ่มทำแบบฟอร์มกันเลย!`;
            ...
            // เพิ่ม message สำหรับวิธีการใช้งานระบบ Checklists
            if (userMessage === "2") {
                const howToText = `📝 "📜 ดูข้อมูลย้อนหลัง 7 วัน" 
