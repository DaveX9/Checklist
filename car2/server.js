    ...
    events.forEach(async (event) => {
        if (event.type === "message" && event.message.type === "text") {
            ...
            if (userMessage === "1") {
                ...
                1. กดเมนู แบบฟอร์ม 2. ระบบจะแสดงแบบฟอร์มเช็กลิสต์ 3. ใส่ชื่อผู้ตรวจ และเลือกทะเบียนรถที่ต้องการเช็ก (วันและเวลา อัตโนมัติ) 4. กดบันทึกข้อมูล และเริ่มทำแบบฟอร์มกันเลย!`;
